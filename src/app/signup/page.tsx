...
export default function SignUpPage() {
	...
	const handleSubmit = async (e: React.FormEvent): Promise<void> => {
		...
		try {
			// Use magic link for signup - it will automatically create account if user doesn't exist
				...
				<Card className="bg-zinc-900 border-zinc-800 shadow-2xl">
					...
					<CardContent>
							...
							<div className="space-y-4">
								<div className="p-4 bg-blue-900/20 border border-blue-700 rounded-lg">
									...
									<p className="text-zinc-300 text-sm text-center">
										...
										If this is your first time, you&apos;ll also receive a verification email.
									</p>
								</div>
								...
								<div className="text-center space-y-2">
									...
									<p className="text-zinc-400 text-xs">
										After clicking the magic link, your account will be created and you&apos;ll be signed in
									</p>
								</div>
							</div>
						) : (
						...
						<div className="mt-6 text-center space-y-2">
							...
							<p className="text-zinc-400 text-xs">
								After signing up, you can register a passkey for even faster
